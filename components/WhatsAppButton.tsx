...
const WA_NUMBER = "51999999999"; // TODO: replace with real FLUX WhatsApp number
      ...
      {visible && (
        ...
        >
          ...
          <AnimatePresence>
            {showTooltip && (
              <motion.div
                ...
                className="bg-white text-[#18191F] text-sm font-500 px-4 py-2.5 rounded-2xl shadow-lg whitespace-nowrap"
                style={{ pointerEvents: "none" }}
              >
                ¿Tienes alguna duda? ✌️
              </motion.div>
            )}
          </AnimatePresence>
          ...
          <motion.a
            ...
            aria-label="Chatea con FLUX en WhatsApp"
