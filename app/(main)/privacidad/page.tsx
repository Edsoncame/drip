      ...
      <div className="space-y-6 text-[#333333]">
        {[
          ...
          },
          {
            ...
            content: "Tienes derecho a Acceder, Rectificar, Cancelar y Oponerte al tratamiento de tus datos. Ejerce tus derechos escribiendo a privacidad@fluxperu.com con tu nombre y DNI. Responderemos en un plazo máximo de 20 días hábiles.",
          },
          {
            title: "7. Seguridad",
